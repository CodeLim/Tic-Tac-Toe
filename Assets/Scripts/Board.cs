...
public class Board : MonoBehaviour {
    ...
    public GameObject mCellPrefab; //variable holding reference to prefab created in unity
    private MyCell[] mCells = new MyCell[9];  
    ...
    public void Build(Main main)
    {
        for(int i=0; i<=8; i++)
        {
            ...
            mCells[i] = newCell.GetComponent<MyCell>();
            mCells[i].mMain = main;
        }
    }
